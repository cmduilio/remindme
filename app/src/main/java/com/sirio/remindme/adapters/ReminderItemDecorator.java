...
public class ReminderItemDecorator extends RecyclerView.ItemDecoration {
...
//    private final Rect mBounds = new Rect();
     ...
     */
    public ReminderItemDecorator(Context context, int orientation, boolean isShowInLastItem) {
